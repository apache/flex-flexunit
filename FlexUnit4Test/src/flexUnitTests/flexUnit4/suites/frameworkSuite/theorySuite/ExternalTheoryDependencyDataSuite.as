...
package flexUnitTests.flexUnit4.suites.frameworkSuite.theorySuite {
	...
	public class ExternalTheoryDependencyDataSuite {
		private var theory:Theories;

		[DataPoints]
		[ArrayElementType("int")]
		public static var intValues:SampleTheoryDataHelper = new SampleTheoryDataHelper( "someFakeDataPath.stuff" );
   		[DataPoints]
		...
		[DataPoints]
		[ArrayElementType("int")]
		public static var arr:Array = [0,9,11];
...
*/
		public function ExternalTheoryDependencyDataSuite():void {
